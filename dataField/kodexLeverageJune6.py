...
#
# z = 0
# while z < len(rawList[11]):
#     tempStart = 0
#     tempEnd = 0
#     if rawList[11][z] < -0.05 and z+20 < len(rawList[1]):
#         tempStart = rawList[1][z]
#         tempEnd = rawList[1][z+20]
#         tempYield = (tempEnd - tempStart) / tempStart
#         yd.append(tempYield)
#         z += 20
#         continue
#     z += 1
...
#         elog1fx += ((1 / len(yd)) * np.log2(1 + f * yd[k]))
#     fList.append(f)
